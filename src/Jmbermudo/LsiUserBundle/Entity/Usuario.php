...
namespace Jmbermudo\LsiUserBundle\Entity;
...
class Usuario extends BaseUser
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="SGR3Bundle/Recurso", mappedBy="responsable", cascade={"persist"})
     */
    private $responsable_de_recursos;
    
    /**
     * @ORM\OneToMany(targetEntity="SGR3Bundle/Reunion", mappedBy="creador", cascade={"all"})
     */
    private $creador_de_reuniones;
    
    /**
     * @ORM\ManyToMany(targetEntity="SGR3Bundle/Reunion", mappedBy="invitados")
     **/
    private $reuniones;
